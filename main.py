...
if __name__ == "__main__":
    ...
    repo.agregar_estado("q0", [1+0j, 0+0j], "computacional")

    # Estado base |1⟩
    repo.agregar_estado("q1", [0+0j, 1+0j], "computacional")

    # Puerta X (NOT)
    X = OperadorCuantico("X", [[0, 1], [1, 0]])

    # Aplicar X a q0 → debería dar |1⟩
    repo.aplicar_operador("q0", X, "q0_X")
    ...
    # Medición
    probabilidades = repo.medir_estado("q0_H")
